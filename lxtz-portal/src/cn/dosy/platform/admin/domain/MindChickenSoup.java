 ...
 */
@Entity
@Table(name = "TBL_LXTZ_MINDCHICKENSOUP")
public class MindChickenSoup extends AbstractDomainEntity implements Serializable {
	...
	public MindChickenSoup() {
		super(true);
		this.isHot = false;
		this.isHidden = false;
	}
	
	public MindChickenSoup(String id, String title, String source, Boolean isHot, Boolean isHidden, Date lastModifiedDate) {
		this.id = id;
		this.title = title;
		this.source = source;
		this.isHot = isHot;
