 ...
 * </p>
 * <p>
 * CreateDate:2014年12月01日
 * </p>
 * 
 * @author MM
 * @history 创建文档；Mender:MM；Date:2014年12月01日；
 */
@Entity
@Table(name = "TBL_LXTZ_NOTICE")
public class Notice extends AbstractDomainEntity implements Serializable {
	...
	public Notice(String id, String title, String source, Boolean isHot, Boolean isHidden, Date lastModifiedDate) {
		this.id = id;
		this.title = title;
		this.source = source;
		this.isHot = isHot;
