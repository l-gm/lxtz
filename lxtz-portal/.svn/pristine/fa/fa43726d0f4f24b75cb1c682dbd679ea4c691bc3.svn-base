...
<tiles:insertDefinition name="defaultTemplate">
	...
	<tiles:putAttribute name="toolbar">    
		<a href="${ctx}/admin/article/notice/del/${entity.id}" class="btn btn-danger">删除</a>
		<a href="${ctx}/admin/article/notice/update/${entity.id}" class="btn btn-warning">修改公告内容</a>
		<a href="${ctx}/admin/article/notice" class="btn btn-default">返回列表</a>
	</tiles:putAttribute>
