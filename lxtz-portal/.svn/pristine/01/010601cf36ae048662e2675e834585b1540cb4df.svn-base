...
<tiles:insertDefinition name="defaultTemplate">
	...
	<tiles:putAttribute name="body">
		<form:form modelAttribute="entity" id="form" method="post" 
			action="${ctx}/admin/article/example/update" class="form-horizontal">
			<div class="panel panel-info">
				...
				<div class="panel-heading text-left">
					...
					<table class="table table-bordered">
						...
						<tr>
							<td class="text">标题</td>
							<td colspan="3"><input type="text" name="title" value="${example.title}"></td>
						</tr>
						<tr>
							<td class="text">案例来源</td>
							<td colspan="3"><input type="text" name="source" value="${example.source}"/></td>
						</tr>
					</table>
					...
					<div align="center">
						<textarea name="content" cols="100" rows="8" style="width:712px;height:500px;visibility:hidden;">${example.content}
						</textarea>
					</div>
					
				<div class="panel-footer text-center">
					<a href="${ctx}/admin/article/example" class="btn btn-default">返回</a>
