			...
			<div class="e_content ce_content fr">
				<div class="e_wrapper">
					<div class="s_partjob active">
						<h2>修改求职信息</h2>
						<form id="form" action="${ctx}/portal/infoCenter/student/studentJob/update" method="post">
							<table>
								<tr>
									<td class="td1">标题：</td>
									<td><input type="text" name="title" value="${studentJob.title}"></td>
								</tr>
								<tr>
									<td class="td1">求职内容：</td>
									<td><textarea class="com_i" rows="10" name="content">${studentJob.content}</textarea></td>
								</tr>
							</table>
