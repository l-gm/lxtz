...
<tiles:insertDefinition name="portalTemplate">
	...
	<div class="register container">
		<div class="reg_box clearfix">
		 ...
		 <form action="${ctx}/login/merchant" id="form" method="post" autocomplete="off" class="form-horizontal">	
			<div class="login_content clearfix">
				<div class="login_l fl">
					<span style="font-size: 20px; font-weight: bold;">
						<font><a href="${ctx}/login/student" style="color: #af1d1d;" id="merchantLogin">个人登录</a></font>
						<font>/</font>
						<font>
							企业登录
						</font>
