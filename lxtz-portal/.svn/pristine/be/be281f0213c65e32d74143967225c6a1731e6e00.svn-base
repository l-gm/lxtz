...
import cn.dosy.platform.config.service.PortalApplicationConfig;
 ...
 */
public class PortalMenuUtils implements Serializable {
	...
	static final Logger logger = LoggerFactory.getLogger(PortalMenuUtils.class);
	...
	public static void findURLMappingTopMenus() {
		...
		PortalApplicationConfig applicationConfig = ApplicationContext.getBean(PortalApplicationConfig.class);
