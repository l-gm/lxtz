	...
	<div class="main container">
		...
		<div class="crumbs">
			<p>
				...
				<a href="${ctx}/portal/newDynamic/comment">用户反馈</a>&nbsp;&gt;&nbsp;
				用户反馈列表
			</p>
		</div>
		<!-- 面包屑 end -->
			...
			<div class="e_content fr">
				<div class="e_wrapper">
					<div class="pt_topbar clearfix">
						<h2 class="fl">用户反馈列表</h2>
					</div>
					
					<div class="e_search_bar">
						<form class="clearfix" id="form">
							<input class="s_txt fl" type="text" placeholder="按内容查找" name="searchFilter" value="${page.vo.content}">
					...
					<c:if test="${page.content != null and fn:length(page.content) != 0}">
						<div class="em_all">
							<ul>
								<li class="li_head">
									<span class="em_title">内容</span>
									<span class="em_area">姓名</span>
									<span class="em_date">反馈时间</span>
								</li>
