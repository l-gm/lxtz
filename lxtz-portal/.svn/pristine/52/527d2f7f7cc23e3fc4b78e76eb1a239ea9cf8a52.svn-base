...
<tiles:insertDefinition name="defaultTemplate">
	...
	<tiles:putAttribute name="toolbar">    
		<a href="${ctx}/admin/article/financial/del/${entity.id}" class="btn btn-danger">删除</a>
		<a href="${ctx}/admin/article/financial/update/${entity.id}" class="btn btn-warning">修改理财内容</a>
		<a href="${ctx}/admin/article/financial" class="btn btn-default">返回列表</a>
	</tiles:putAttribute>
			...
			<div class="panel panel-info">
				...
				<div class="panel-heading text-left">
					...
					<table class="table table-bordered">
						...
						<tr>
							<td class="text">摘要</td>
							<td colspan="3">${entity.financialAbstract}</td>
						</tr>
					</table>
