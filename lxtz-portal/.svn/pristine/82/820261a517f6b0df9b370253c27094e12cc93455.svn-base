...
<tiles:insertDefinition name="defaultTemplate">
	...
	<tiles:putAttribute name="toolbar">    
		<a href="${ctx}/admin/article/usingHelp/del/${entity.id}" class="btn btn-danger">删除</a>
		<a href="${ctx}/admin/article/usingHelp/update/${entity.id}" class="btn btn-warning">修改使用帮助</a>
		<a href="${ctx}/admin/article/usingHelp" class="btn btn-default">返回列表</a>
	</tiles:putAttribute>

	<tiles:putAttribute name="body">
		<form:form modelAttribute="entity" id="form" method="post" 
			action="${ctx}/admin/article/usingHelp/save" class="form-horizontal">
