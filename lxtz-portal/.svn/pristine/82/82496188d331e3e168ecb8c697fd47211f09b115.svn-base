...
<tiles:insertDefinition name="defaultTemplate">
	...
	<tiles:putAttribute name="body">
		...
		<form:form modelAttribute="entity" id="form" action="${ctx}/admin/article/mindChickenSoup/save" method="post" class="form-horizontal">
		...
		<div class="panel panel-info">
				...
				<div class="panel-heading text-left">
					...
					<div align="center">
						<textarea name="content" cols="100" rows="8" style="width:712px;height:500px;visibility:hidden;">
						</textarea>
					</div>
