...
<tiles:insertDefinition name="portalTemplate">
	...
	<div class="main container">
		...
		<div class="crumbs">
			<p>
				<a href="${ctx}/portal/mindChickenSoup">心灵鸡汤</a>&nbsp;&gt;&nbsp;
				<a href="${ctx}/portal/mindChickenSoup">心灵鸡汤文章</a>&nbsp;&gt;&nbsp;
				心灵鸡汤列表
			</p>
		</div>
		<!-- 面包屑 end -->
			...
			<div class="e_content fr">
				<div class="e_wrapper">
					<div class="pt_topbar clearfix">
						<h2 class="fl">心灵鸡汤列表</h2>
					</div>
					
					<div class="e_search_bar">
						<form class="clearfix" id="form">
							<input class="s_txt fl" type="text" placeholder="按标题、内容查找" name="search" value="${page.vo.title}">
						...
						<div class="em_all">
							...
							<ul>
								...
								<c:forEach items="${page.content}" var="_item">
									<li>
										<a href="${ctx}/portal/mindChickenSoup/view/${_item.id}">
