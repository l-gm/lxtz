			...
			<div class="e_content fr">
				<div class="e_wrapper">
					<div class="pt_topbar clearfix">
						<h2 class="fl">简历中心列表</h2>
					</div>
					
					<div class="e_search_bar">
						<form class="clearfix" id="form">
							<input class="s_txt fl" type="text" placeholder="按标题、内容查找" name="searchStudentJob" value="${page.vo.title}">
						...
						<div class="em_all">
							...
							<ul>
								<li class="li_head">
									...
									<span class="em_area">姓名</span>
									<span class="em_date">发布时间</span>
								</li>
								<c:forEach items="${page.content}" var="_item">
									<li>
										<a href="${ctx}/portal/partTime/studentJob/view/${_item.id}">
											<span class="em_title">${_item.title}</span>
											<span class="em_area">${_item.student.name}</span>
