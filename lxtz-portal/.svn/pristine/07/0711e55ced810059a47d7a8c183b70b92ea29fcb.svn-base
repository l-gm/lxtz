 ...
 */
@Entity
@Table(name = "TBL_LXTZ_INVESTMENT")
public class Investment extends AbstractDomainEntity implements Serializable {
	...
	public Investment(String id, String title, String source, Boolean isHot, Boolean isHidden, Date lastModifiedDate) {
		this.id = id;
		this.title = title;
		this.source = source;
		this.isHot = isHot;
