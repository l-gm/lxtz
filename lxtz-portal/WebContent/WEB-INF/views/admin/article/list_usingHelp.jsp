			...
			<div class="panel-heading text-left">
				...
				<div class="panel-footer">
					<table style="width: 100%;">
						<tr>
							<td>
								<a href="${ctx}/admin/article/usingHelp/add" class="btn btn-primary">添加使用帮助</a>
							</td>
							<td class="text-right">
			...
			<div class="panel panel-info">
				<table class="table table-hover table-bordered table-list">
					...
					<c:forEach items="${page.content}" var="_item">
						<tr>
							<td>
								<a href="${ctx}/admin/article/usingHelp/view/${_item.id}" class="btn btn-xs btn-info" data-action="open" data-size="650,600">
							...
							<td>
								<a href="${ctx}/admin/article/usingHelp/setHidden/${_item.id}" class="btn btn-primary">
									${_item.isHidden == true ? '取消隐藏' : '隐藏' }
								</a>
								<a href="${ctx}/admin/article/usingHelp/del/${_item.id}" class="btn btn-danger">删除</a>
							</td>
						</tr>
					</c:forEach>
				</table>
