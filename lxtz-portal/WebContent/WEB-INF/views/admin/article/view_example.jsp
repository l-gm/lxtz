...
<tiles:insertDefinition name="defaultTemplate">
	...
	<tiles:putAttribute name="toolbar">    
			<a href="${ctx}/admin/article/example/del/${entity.id}" class="btn btn-danger">删除</a>
			<a href="${ctx}/admin/article/example/update/${entity.id}" class="btn btn-warning">修改成功案例</a>
			<a href="${ctx}/admin/article/example" class="btn btn-default">返回列表</a>
	</tiles:putAttribute>

	<tiles:putAttribute name="body">
		<form:form modelAttribute="entity" id="form" method="post" 
			action="${ctx}/admin/article/example/save" class="form-horizontal">
