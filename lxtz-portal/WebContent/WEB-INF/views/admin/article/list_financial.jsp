			...
			<div class="panel-heading text-left">
				...
				<div class="panel-footer">
					<table style="width: 100%;">
						<tr>
							<td>
								<a href="${ctx}/admin/article/financial/add" class="btn btn-primary">添加理财频道</a>
							</td>
							<td class="text-right">
			...
			<div class="panel panel-info">
				<table class="table table-hover table-bordered table-list">
					...
					<c:forEach items="${page.content}" var="_item">
						<tr>
							<td>
								<a href="${ctx}/admin/article/financial/view/${_item.id}" class="btn btn-xs btn-info" data-action="open" data-size="650,600">
							...
							<td>
								<a href="${ctx}/admin/article/financial/setHot/${_item.id}" class="btn btn-info">
									${_item.isHot == true ? '取消置顶' : '置顶' }
								</a>
								<a href="${ctx}/admin/article/financial/setHidden/${_item.id}" class="btn btn-primary">
									${_item.isHidden == true ? '取消隐藏' : '隐藏' }
								</a>
								<a href="${ctx}/admin/article/financial/del/${_item.id}" class="btn btn-danger">删除</a>
							</td>
						</tr>
					</c:forEach>
				</table>
