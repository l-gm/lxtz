...
<tiles:insertDefinition name="defaultTemplate">
	...
	<tiles:putAttribute name="body">
		<form:form modelAttribute="entity" id="form" method="post" 
			action="${ctx}/admin/article/notice/update" class="form-horizontal">
				...
				<div class="panel-heading text-left">
					...
					<table class="table table-bordered">
						...
						<tr>
							...
							<td colspan="3"><input type="text" name="source" value="${notice.source}"/></td>
						</tr>
					</table>
					...
					<div align="center">
						<textarea name="content" cols="100" rows="8" style="width:712px;height:500px;visibility:hidden;">${notice.content}
						</textarea>
					</div>
					
				<div class="panel-footer text-center">
					<a href="${ctx}/admin/article/notice" class="btn btn-default">返回</a>
